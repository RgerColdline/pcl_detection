...
# Pane 3: points_sample.launch (修正工作空间路径)
tmux split-window -v -t ros_session:1
tmux send-keys -t ros_session:1.1 'sleep 7; source ~/group2_ws/devel/setup.zsh; roslaunch pcl_detection points_sample.launch' C-m
